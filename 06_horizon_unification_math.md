...
1. **기존 지평선 개념들과의 비교:**
   - **블랙홀 사건의 지평선 (Bekenstein-Hawking, 1973–1975):** 역사적으로 사건의 지평선은 매끄러운 고전적 로런츠 시공간 배경 위에서 정보의 통과를 차단하는 경계면으로 정의되었으며, 그 면적에 비례하는 엔트로피($S = A/4G$)와 호킹 온도($T_H = \hbar c^3 / 8\pi G k_B M$)를 갖는 열역학적 대상으로 해석되었다. 반면 HNM은 근본적으로 다르다. HNM은 기하학적 시공간을 먼저 가정하고 그 내부에서 지평선 경계를 찾는 것이 아니라, **"지평선 정보 용량" 자체를 양자 정보적/대수적 제일원리(UV starting point)로 삼는다.** 지평선의 면적이 좌표 대수의 절대 차원 $N$을 결정하며, 고전적 시공간과 지평선 기하는 유한 차원 대수 $\text{Mat}_N(\mathbb{C})$로부터 *동시에 창발*한다.
   ...
   - **행렬 모델 (IKKT/BFSS, 1996–1997):** 기존의 행렬 모델들은 시공간 좌표를 $N \times N$ 행렬로 다루었으나, 대개 정적인 거대-$N$ 극한($N \to \infty$)을 취하거나 평평한 민코프스키 공간 혹은 배경 독립적 타깃 공간 상에서 $N$을 고정하여 전개했다. 이들은 $N$을 관측 가능한 물리적 지평선과 직접 연결시키지 않았다. HNM은 **행렬 크기 $N$을 우주론적 지평선의 물리적 면적과 직접 동정($N \propto R_H^2 \propto \text{Area}$)**한 최초의 이론이다.

2. **HNM의 핵심 독창적 기여:**
   - **지평선 면적과 힐베르트 공간 차원의 등치 ($N \propto R_H^2$):** HNM은 관측 가능한 우주론적 지평선의 면적을 대수적 차원 $N$과 동일한 물리적 대상으로 공식화한 최초의 이론이다. "행렬 액적"의 경계는 인위적인 장벽이 아니라 좌표 관측의 절대적 한계면이며, 이는 홀로그래픽 한계를 대수적 수준에서 자연스럽게 실현한다.
...
1. **지평선상의 세상과 시공간의 창발:**
   우리가 살고 있는 4차원 시공간은 무한하고 빈 배경이 아니다. HNM에 따르면, 시공간은 유한 차원 힐베르트 공간의 크기 $N$을 지닌 비가환 행렬 대수 $\text{Mat}_N(\mathbb{C})$가 형성하는 "행렬 액적(Matrix Droplet)"의 스펙트럼 응집체이다. 이 액적의 물리적 경계면이 곧 우주론적 지평선 $R_H$이며, 지평선 내부의 3차원 벌크 공간은 지평선 경계에 인코딩된 유한한 대수적 자유도들의 홀로그래픽 사영에 불과하다. 즉, **물리적 세상의 본체는 지평선에 정의된 대수계(C\*-대수)이며, 우리는 지평선에 투영되어 창발된 시공간 속에서 살아가고 있다.**

2. **지평선으로 인해 발생하는 물리적 한계들의 해석:**
   우주에서 관측되는 절대적인 물리적 한계들은 지평선이라는 유한 정보 장막의 수학적 필연성으로 나타난다:
...
**수학적 일관성:** 이 되살아남 기작을 통해 HNM 분배 함수는 제시된 조건에서 **보렐 합산 가능(Borel summable)**하다. 우주의 비섭동적 경로적분은 형식적인 근사가 아니며, 복소 결합 평면 전체에서 수학적으로 유일하게 잘 정의된 해석 함수(analytic function)이다. 강결합 영역은 어떠한 특이 장벽도 거치지 않고 약결합 영역으로 해석적으로 연속(analytic continuation)되어, HNM을 수학적으로 완비되고 비섭동적으로 정확한 최초의 양자 중력 이론으로 확립한다.
...
3세대의 도출은 비가환 **아티야-싱어 지수 정리(Atiyah-Singer Index Theorem)** [1, 13]를 통해 절대적인 수학적 엄밀성으로 격상될 수 있다. 스펙트럼 삼조에서 카이랄 페르미온 세대의 순 개수($N_L - N_R$)는 내부 퍼지 다양체 위에서 정의된 카이랄 디랙 연산자 $\mathcal{D}_{\text{int}}^+$의 프레드홀름 지수(Fredholm index)로 주어진다.
...
기저의 행렬 모형이 정확한 체른-사이먼스 형태의 위상학적 항을 가지므로, 진공의 근본 들뜸(excitation)은 점 입자가 아니라 꼬이고 엮인 위상학적 매듭 상태들이다. 이는 물질의 위상학적 상과 시공간 매듭이 HNM 진공 위상의 절대적 기반이며, 어떠한 국소적 계량 섭동에도 정합적으로 불변함을 엄밀하게 정식화한다.
...
따라서 HNM 체계는 오랫동안 물리학계의 숙원이었던 루프 양자 중력과 끈 이론(행렬 모형) 간의 엄밀한 수학적 등가성을 제공한다. LQG의 운동학적 힐베르트 공간은 단지 기저 행렬 대수의 기저(basis)일 뿐이며, LQG의 부피 및 면적 연산자 고윳값은 비가환 행렬 교환자(commutator)와 정합적으로 일치한다. 결과적으로 루프 양자 중력은 HNM 행렬 액적의 정확한 스핀 네트워크 이산화(discretization)에 불과하다.
...
즉, **유클리드 공간이 절대적 경로적분 안정성과 수학적 토대를 제공하는 반면, 로렌츠 시공간과 그 부호는 지평선에 갇힌 관측자가 측정하는 모듈러 상관 함수의 대수적 성질로서 창발한다.** 이때 KMS 모듈러 온도는 지평선의 호킹 온도와 해석학적으로 정합적으로 일치한다:
